...
void struct_thigh(void)
{
  ...
  glPushMatrix();
	glTranslatef(0,-0.2,0);
    glRotatef(90,1,0,0);
	gluCylinder(quad,0.2,0.22,3.2,10,5);
	glTranslatef(0,0,0.8);
	gluCylinder(quad,0.22,0.2,0.8,10,5);
	glTranslatef(0,0,0.8);
	gluDisk(quad,0,0.2,10,5);
  glPopMatrix();
  glEndList();
